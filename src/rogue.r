...
of this task will be a full membership in the local guild, plus you are allowed to keep
...
oriented.  Commands are all one or two keystrokes
.FS
...
.cs R
Level: 1  Gold: 0      Hp: 12(12)  Str: 18  Ac: 6  Exp: 1/0
.fi
.in 0
.NH 2
The bottom line
...
at one and goes up forever.
.FS
Or until you get killed or decide to quit.
.FE
.IP Gold
This is the number of gold pieces you have managed to find and keep with
you so far.
.IP Hp
This is your current and maximum hit points.  Hit points indicate how much
damage you can take before you die.  The more you fight, the lower they get.
You can regain hit points by resting. The number in parentheses is
the maximum number your hit points can reach.
.IP Str
This is your current strength.  This can be any integer less than or
equal to eighteen.  The higher the number, the stronger you are.
.IP Ac
This is your current armor class.  This number indicates how effective
...
.IP )
This is a weapon of some sort.
.IP ]
This is a piece of armor.
.IP !
This is a flask containing a magic potion.
.IP ?
This is a piece of paper, usually a magic scroll.
.IP ^
This is a trap, watch out for these.
.IP %
This is the passage leading down to the next level.
.IP :
This is a piece of food.
.IP A-Z
...
followed by any character that you see on the level, will tell you what
that character is.  For instance, typing /@ will tell you that the
@ symbol represents
you, the player.
.IP d
...
types have different armor classes.  If a piece of armor is enchanted or
...
variable.  On V6 systems, there is no equivalent of
...
first option and waits for you to type.  You can type a "+" which means to go to
the next option, a "\-" which means to go to the previous option, an
...
This is a useful option for those on slow terminals.
.IP "jump [nojump]"
...
Mark Horton and Jan Miller for their ideas
and assistance.
